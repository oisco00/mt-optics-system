@echo off
setlocal
echo APPLY_FINAL_ENHANCEMENTS_V313 check...
...
node --check frontend\final-enhancements-v313.js || goto fail
node --check frontend\postcode-kakao-v313.js || goto fail
echo SUCCESS: APPLY_FINAL_ENHANCEMENTS_V313 check completed.
pause
exit /b 0
:fail
