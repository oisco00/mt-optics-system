...
function renderShell() {
  ...
  appEl.innerHTML = `
    <div class="app-shell">
      ...
      <main class="main">
        <header class="topbar">
          <div><strong>${escapeHtml(pages.find((p) => p.id === state.page)?.label || '')}</strong><div class="muted">PC 테스트와 Netlify 배포를 모두 지원합니다.</div></div>
...
// MT_OPTICS_FINAL_FEATURES_LOADER_V314
import('/final-enhancements-v314-core.js?v=314').catch(console.error);
import('/final-enhancements-v314.js?v=314').catch(console.error);
