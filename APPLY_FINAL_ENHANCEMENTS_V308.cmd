...
cd /d "%~dp0"
echo ============================================================
echo MT Optics APPLY_FINAL_ENHANCEMENTS_V308
echo ============================================================
...
node --check frontend\final-enhancements-v308.js || goto fail
node --check frontend\postcode-kakao-v308.js || goto fail
echo.
echo SUCCESS: APPLY_FINAL_ENHANCEMENTS_V308 check completed.
