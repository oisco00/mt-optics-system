...
cd /d "%~dp0"
echo ============================================================
echo MT Optics APPLY_FINAL_ENHANCEMENTS_V311
echo ============================================================
...
node --check frontend\final-enhancements-v311.js || goto fail
node --check frontend\postcode-kakao-v311.js || goto fail
echo.
echo SUCCESS: APPLY_FINAL_ENHANCEMENTS_V311 check completed.
